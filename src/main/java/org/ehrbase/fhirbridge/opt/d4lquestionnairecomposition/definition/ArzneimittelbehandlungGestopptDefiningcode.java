...
public enum ArzneimittelbehandlungGestopptDefiningcode implements EnumValueSet {
  ARZNEIMITTELBEHANDLUNGGESTOPPT("Arzneimittelbehandlung gestoppt", "Die Verabreichung des Arzneimittels wurde während der Dauer der geplanten Behandlung eingestellt.", "local", "at0015");
