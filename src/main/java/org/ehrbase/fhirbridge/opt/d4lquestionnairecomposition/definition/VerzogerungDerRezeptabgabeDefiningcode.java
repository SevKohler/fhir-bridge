...
public enum VerzogerungDerRezeptabgabeDefiningcode implements EnumValueSet {
  VERZOGERUNGDERREZEPTABGABE("Verzögerung der Rezeptabgabe", "Das Rezept wurde aufgrund einer technischen oder pharmazeutischen Störung nicht ausgegeben.", "local", "at0008");
