...
public class DiagnoseEvaluationContainment extends Containment {
  ...
  public SelectAqlField<ProblemDiagnoseKrankheitsanzeichenChoice> KRANKHEITSANZEICHEN = new AqlFieldImp<ProblemDiagnoseKrankheitsanzeichenChoice>(DiagnoseEvaluation.class, "/data[at0001]/items[openEHR-EHR-CLUSTER.symptom_sign.v1]", "krankheitsanzeichen", ProblemDiagnoseKrankheitsanzeichenChoice.class, this);
